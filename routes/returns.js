const { Rental, validateRentalReturn } = require("../models/rental");
...
router.post("/", [auth, validateReqBody(validateRentalReturn)], async (req, res) => {
  ...
  rental.return(rental.dateReturned);
